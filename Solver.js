...
class Solver {
    ...
    getBoard(clues) {
        ...
        let possibleNumbers = this.createPossibleNumbers(this.numbBuildings);
    ...
    getBoardHeapEfficient(clues) {
        this.startTime = new Date().getTime();
        this.rules = clues;
        this.numbBuildings = clues.length / 4;
        this.permutationBuilder = new Perms_1.Perms();
        let empty2dArray = Grid_1.Grid.getBlankGrid(this.numbBuildings);
        let possibleNumbers = this.createPossibleNumbers(this.numbBuildings);
        let startGrid = new Grid_1.Grid(empty2dArray, possibleNumbers);
        this.addDefinites(startGrid);
    ...
    createPossibleNumbers(numbRows) {
        let possibleNumbers = [];
        let allNumbers = [];
